...
parser.add_argument('--data', type=str, required=True, help='path to UQ csv file')
...
if not os.path.exists(args.data):
    sys.exit('Path to data does not exist or is not a file')
    
print('loading data')
data = pd.read_csv(args.data, dtype=UQ_dtypes)
